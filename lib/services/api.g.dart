...
class _BackendApi implements BackendApi {
  _BackendApi(
    ...
    baseUrl ??=
        'https://1982-2a00-a041-e03f-ff00-d183-5316-23ad-816c.ngrok-free.app';
  }
  ...
  Future<void> highlightChunk(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/video/journeys/${journeyId}/chunks/${chunkId}/highlight',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> unhighlightChunk(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/video/journeys/${journeyId}/chunks/${chunkId}/unhighlight',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
